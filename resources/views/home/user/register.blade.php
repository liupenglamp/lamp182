...
<html>
    ...
    <head lang="en">
        ...
        <link rel="stylesheet" href="/d/AmazeUI-2.4.2/assets/css/amazeui.min.css" />
        <link href="/d/css/dlstyle.css" rel="stylesheet" type="text/css">
        <script src="/d/AmazeUI-2.4.2/assets/js/jquery.min.js"></script>
        <script src="/d/AmazeUI-2.4.2/assets/js/amazeui.min.js"></script>
    </head>
    
    <body>
        <div class="login-boxtitle">
            <a href="home/demo.html">
                <img alt="" src="/d/images/logobig.png" /></a>
        </div>
        <div class="res-banner">
            <div class="res-main">
                <div class="login-banner-bg">
                    <span></span>
                    <img src="/d/images/big.jpg" /></div>
                <div class="login-box">
                    <div class="am-tabs" id="doc-my-tabs">
                        ...
                        <div class="am-tabs-bd">
                            ...
                            <!-- 邮箱注册 -->
                                <form method="post" action="/home/register/email">
                                {{ csrf_field() }}
                                    ...
                                    $(function(){
                                        $('input').eq(1).blur(function(){
                                           $.ajax({
                                                ...
                                                async:true,
                                                data:{
                                                    'email':$('input').eq(1).value,
                                                    'password':$('input').eq(2).value,
                                                    'repassword':$('input').eq(3).value
                                                },
